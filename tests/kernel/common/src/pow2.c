...
/*
 * Clang 18 (and likely others) warns that "variable length array folded to
 * constant array as an extension" [-Wgnu-folding-constant] when using
 * built-ins in a static array size.
 */
