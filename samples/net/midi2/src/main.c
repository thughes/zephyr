...
NETMIDI2_EP_DEFINE(midi_server, DT_PROP(MIDI2_NODE, label), NULL, 0);
...
NETMIDI2_EP_DEFINE_WITH_AUTH(midi_server, DT_PROP(MIDI2_NODE, label), NULL, 0,
...
NETMIDI2_EP_DEFINE_WITH_USERS(midi_server, DT_PROP(MIDI2_NODE, label), NULL, 0,
